...
with DAG(
    ...
    collect_data_task = PythonOperator(
        ...
        op_kwargs={'bucket_name': 'dataai-chung-9999'},  # Replace with your bucket name
    )

    # Task 2: Load data from GCS to BigQuery
    load_to_bq_task = GCSToBigQueryOperator(
        task_id='load_to_bigquery',
        bucket='dataai-chung-9999',  # Replace with your bucket name
        source_objects=['raw/coingecko/*.json'],  # Load all JSON files in the folder
        destination_project_dataset_table='dataai_chung_9999.coingecko_price',
